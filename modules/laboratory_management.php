...
$modules = [
    'admin' => ['Test Request', 'Test Types', 'Test Results', 'Lab Billing Management'],
    'lab_technician' => ['Test Request', 'Test Types', 'Test Results', 'Lab Billing Management'],
    'dentist' => ['Test Request', 'Test Results']
];
...
<head>
    ...
    <title>Laboratory Management - Dental Management System</title>
                ...
                foreach ($modules[$role] as $module) {
                    ...
                    switch ($module) {
                        case 'Test Request':
                            ...
                            break;
                        case 'Test Types':
                            echo "<a href='../modules/lab_functions/test_types/test_types_management.php' class='btn btn-primary module-btn'>
                                   More Info &nbsp&nbsp&nbsp <i class='bi bi-arrow-right'></i> </a>";
                            break;
                        case 'Test Results':
                            echo "<a href='../modules/lab_functions/test_results/test_result_management.php' class='btn btn-primary module-btn'>
                                   More Info &nbsp&nbsp&nbsp <i class='bi bi-arrow-right'></i> </a>";
                            break;
                        case 'Lab Billing Management':
                            echo "<a href='../modules/lab_functions/lab_billing/lab_billing_management.php' class='btn btn-primary module-btn'>
                                   More Info &nbsp&nbsp&nbsp <i class='bi bi-arrow-right'></i> </a>";
                            break;
                    }
